...
const PostComposer: React.FC<PostComposerProps> = ({ user, placeholder = "What's on your mind?", onPost, className = '', ...props }) => {
    ...
    return (
        <div className={`post-composer ${className}`} {...props}>
            <div className='post-composer__header'>
                <Avatar src={user?.icon?.url || undefined} alt={user.name} fallbackText={user.name} size='medium' />
