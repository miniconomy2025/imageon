...
// Set up Note object dispatcher for activities path
federation.setObjectDispatcher(Note, '/users/{identifier}/activities/{noteId}', FederationHandlers.handleNoteRequest);
